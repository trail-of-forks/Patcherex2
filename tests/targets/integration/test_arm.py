...
from patcherex2.targets import ELF_ARM_LINUX
...
class Tests(IntegrationTestMixin):
    ...
    def test_raw_file_patch_pie(self):
        self.run_one(
            "printf_pie",
            [ModifyRawBytesPatch(0x5DF, b"No", addr_type=AddressType.FILE)],
            expected_output=b"No",
            expected_return_code=0,
        )
