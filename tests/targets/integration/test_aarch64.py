...
class Tests(IntegrationTestMixin):
    ...
    def test_raw_file_patch_pie(self):
        self.run_one(
            "printf_pie",
            [ModifyRawBytesPatch(0x7AB, b"No", addr_type=AddressType.FILE)],
            expected_output=b"No",
            expected_return_code=0,
        )
    ...
    def test_insert_instruction_patch_c(self):
        ...
        self.run_one(
            ...
            [
                InsertInstructionPatch(
                    0x760, instrs, language=InstructionPatchLanguage.C, c_config=config
                )
            ],
    ...
    def test_insert_instruction_patch_c_asm_header(self):
        ...
        self.run_one(
            ...
            [
                InsertInstructionPatch(
                    0xA20, instrs, language=InstructionPatchLanguage.C, c_config=config
                )
            ],
    ...
    def test_insert_instruction_patch_c_float(self):
        ...
        self.run_one(
            ...
            [
                InsertInstructionPatch(
                    0x774, instrs, language=InstructionPatchLanguage.C, c_config=config
                )
            ],
            expected_output=expected_output,
            expected_return_code=0,
